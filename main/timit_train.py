...
flags.DEFINE_string('datadir', '/home/dev/temp/github/data/timit', 'set the data root directory')
flags.DEFINE_string('logdir', '/home/dev/temp/github/log/timit', 'set the log directory')
